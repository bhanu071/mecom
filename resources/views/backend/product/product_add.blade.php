               ...
               <div class="border border-3 p-4 rounded">
                ...
                <div class="mb-3">
                 ...
                 <div class="mb-3">
                    ...
                    <input class="form-control" name="product_thambnail" type="file" id="formFile" onChange="mainThumbUrl(this) ">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-check">
                          <input class="form-check-input" name="hot_deals" type="checkbox" value="" id="flexCheckDefault">
                          <label class="form-check-label" for="flexCheckDefault">Hot Deals</label>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-check">
                          <input class="form-check-input" name="featured" type="checkbox" value="" id="flexCheckDefault">
